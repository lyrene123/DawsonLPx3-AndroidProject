...
public class FriendInCourseFragment extends Fragment {
    ...
    private FriendInCourseFragment.OnFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof FriendBreakFragment.OnFragmentInteractionListener) {
            mListener = (FriendInCourseFragment.OnFragmentInteractionListener) context;
        } else {
